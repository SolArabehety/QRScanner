...
private fun CreateQRScreenInternal(
    ...
    when (uiState) {
        ...
        is CreateQRUiState.Success -> {
            SuccessScreen(uiState.qrImage, uiState.qrValue, uiState.expiresInSeconds)
        }
    }
}
...
@Composable
private fun SuccessScreen(qrImage: Bitmap, qrText: String, expiresIn: Int) {
    Box(
